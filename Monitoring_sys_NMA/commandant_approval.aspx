<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="commandant_approval.aspx.cs" Inherits="Monitoring_sys_NMA.commandant_approval" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     <div style="margin-left: 50px; margin-right: 50px; margin-top: 100px; background-color: ghostwhite; margin-bottom: 50px;">
        <asp:Panel ID="Panel3" runat="server" Font-Bold="True" Font-Overline="False" BorderColor="WhiteSmoke" Font-Size="XX-Small" GroupingText="COMMANDANT APPROVAL" BackColor="White" ForeColor="#000099">

            <%-- first--%>
            <div class="row">
                  <div class="form-group col-md-4">
                    <label for="exampleInputPassword1" style="font-size: medium">SCHOOL</label>
                    <asp:DropDownList ID="DropDownList1" AutoPostBack="true" runat="server" CssClass="form-control" OnSelectedIndexChanged="DropDownList1_SelectedIndexChanged"></asp:DropDownList>                   
                </div>
                 <div class="form-group col-md-4">
                    <label for="exampleInputPassword1" style="font-size: medium">COURSE</label>
                      <asp:DropDownList ID="DropDownList2" AutoPostBack="true" runat="server" CssClass="form-control"></asp:DropDownList>                                  
                </div>
                <div class="form-group col-md-4">
                    <asp:Button ID="Button4" runat="server" CssClass="btn btn-success" Text="Search" OnClick="Button4_Click"/>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <asp:GridView ID="GridView1" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                    <Columns>
            ...
            <asp:GridView ID="GridView2" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
           ...
           <%-- third--%>
            ...
            <asp:GridView ID="GridView3" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
                    <asp:TemplateField HeaderText="SR_NO">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("srno")%>'></asp:Label>
        ...
        <div class="row">
            ...
            <asp:GridView ID="GridView4" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
                    <asp:TemplateField HeaderText="SR_NO">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("sr_no")%>'></asp:Label>
           ...
           <%-- five--%>
            ...
            <asp:GridView ID="GridView5" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
...
<br />
           ...
           <%-- SIX--%>
            ...
            <asp:GridView ID="GridView6" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
                       <asp:TemplateField HeaderText="SR_NO">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("srno")%>'></asp:Label>
           ...
           <%-- SEVEN--%>
            ...
            <asp:GridView ID="GridView7" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px">
                <Columns>
        ...
        <br />
        <div class="row">
            <asp:Button ID="Button2" runat="server" CssClass="btn btn-success" Text="Approved" OnClick="Button2_Click"/>
        </div>
        </div>
            <div class="row">
                <asp:TextBox ID="TextBox1" runat="server" TextMode="MultiLine" Width="300px" placeholder="Remark.."></asp:TextBox>
            <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Reject"/>
        </div>
    </div>
</asp:Content>
