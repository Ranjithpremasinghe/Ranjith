<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ci_authorization.aspx.cs" Inherits="Monitoring_sys_NMA.ci_authorization" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
     ...
     <div style="margin-left: 50px; margin-right: 50px; margin-top: 100px; background-color: ghostwhite; margin-bottom: 50px;">
        <asp:Panel ID="Panel3" runat="server" Font-Bold="True" Font-Overline="False" BorderColor="WhiteSmoke" Font-Size="Medium" GroupingText="CI AUTHORIZATION" BackColor="White" ForeColor="#000099">
