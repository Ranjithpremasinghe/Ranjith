...
{
    public partial class ci_authorization : System.Web.UI.Page
    {
        ...
        private void griddata()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[daily_schedule] where po='1' and do='1' and ci='0' and school_id='" + school + "'", con);
        ...
        private void griddeviation()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[subject_deviation] where po='1' and do='1' and ci='0' and school_id='" + school + "'", con);
                DataTable filedt = new DataTable();
                SqlDataAdapter filesda = new SqlDataAdapter(cmd);
                filesda.Fill(filedt);
        ...
        private void grid_extra_activity()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[extra_activity] where po='1' and do='1' and ci='0' and school='" + school + "'", con);
                DataTable filedt = new DataTable();
                SqlDataAdapter filesda = new SqlDataAdapter(cmd);
                filesda.Fill(filedt);
        ...
        private void grid_default_1()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[defaulters_1] where po='1' and do='1' and ci='0' and school_id='" + school + "'", con);
                DataTable filedt = new DataTable();
                SqlDataAdapter filesda = new SqlDataAdapter(cmd);
                filesda.Fill(filedt);
        ...
        private void grid_default_2()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[defaulters_2] where po='1' and do='1' and ci='0' and school='" + school + "'", con);
                DataTable filedt = new DataTable();
                SqlDataAdapter filesda = new SqlDataAdapter(cmd);
                filesda.Fill(filedt);
        ...
        private void grid_working_party1()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[working_party_1] where po='1' and do='1' and ci='0' and school='" + school + "'", con);
                DataTable filedt = new DataTable();
                SqlDataAdapter filesda = new SqlDataAdapter(cmd);
                filesda.Fill(filedt);
        ...
        private void grid_working_party2()
        {
            ...
            {
                con.Open();
                SqlCommand cmd = new SqlCommand("select * from [dbo].[working_party_2] where po='1' and do='1' and ci='0' and school='" + school + "'", con);
                DataTable filedt = new DataTable();
                SqlDataAdapter filesda = new SqlDataAdapter(cmd);
                filesda.Fill(filedt);
        ...
        private void update_daily_schedule()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[daily_schedule] set ci=@ci where school_id='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
                con.Close();
                //ScriptManager.RegisterStartupScript(this, this.GetType(), "script", "alert('Update Sucessfully');", true);                             
            }
        ...
        private void update_deviation()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[subject_deviation] set ci=@ci where school_id='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
        ...
        private void update_extra_activity()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[extra_activity] set ci=@ci where school='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
        ...
        private void update_default_1()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[defaulters_1] set po=@ci where school_id='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
        ...
        private void update_default_2()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[defaulters_2] set ci=@ci where school='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
        ...
        private void update_working_1()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[working_party_1] set ci=@ci where school='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
        ...
        private void update_working_2()
        {
            ...
            using (SqlConnection con = new SqlConnection(connection))
            {
                ...
                con.Open();
                //SqlCommand cmd = new SqlCommand("login_gridview_update", con);
                SqlCommand cmd = new SqlCommand("update [dbo].[working_party_2] set ci=@ci where school='" + school + "'", con);
                //cmd.CommandType = System.Data.CommandType.StoredProcedure;
                cmd.CommandType = CommandType.Text;
                cmd.Parameters.AddWithValue("@ci", "1");
                cmd.ExecuteNonQuery();
