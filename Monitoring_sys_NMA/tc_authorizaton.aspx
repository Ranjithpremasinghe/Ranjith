<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="tc_authorizaton.aspx.cs" Inherits="Monitoring_sys_NMA.tc_authorizaton" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
      ...
      <div style="margin-left: 50px; margin-right: 50px; margin-top: 100px; background-color: ghostwhite; margin-bottom: 50px;">
        <asp:Panel ID="Panel3" runat="server" Font-Bold="True" Font-Overline="False" BorderColor="WhiteSmoke" Font-Size="XX-Small" GroupingText="TC  AUTHORIZATION" BackColor="White" ForeColor="#000099">
...
<br />
        ...
        <div class="row">
            ...
            <asp:Button ID="Button1" runat="server" CssClass="btn btn-success" Text="Reject" OnClick="Button1_Click"/>
        </div>

          <br />

           <div class="row">
            <asp:Button ID="Button3" runat="server" CssClass="btn btn-success" Text="previous Approved" OnClick="Button3_Click"/>
        </div>
