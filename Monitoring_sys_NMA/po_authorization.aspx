 <%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="po_authorization.aspx.cs" Inherits="Monitoring_sys_NMA.po_authorization" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div style="margin-left: 50px; margin-right: 50px; margin-top: 100px; background-color: ghostwhite; margin-bottom: 50px;">
        <asp:Panel ID="Panel3" runat="server" Font-Bold="True" Font-Overline="False" BorderColor="WhiteSmoke" Font-Size="Small" GroupingText="DIVISIONAL PETTY OFFICER" BackColor="White" ForeColor="#000099" style="margin-top: 100px">
             ...
             <div class="row">
                 ...
                 <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" CellPadding="4" DataKeyNames="id" OnRowCancelingEdit="GridView2_RowCancelingEdit" OnRowDeleting="GridView2_RowDeleting" OnRowEditing="GridView2_RowEditing" OnRowUpdating="GridView2_RowUpdating" OnSelectedIndexChanged="GridView2_SelectedIndexChanged" Width="900">
                     <Columns>
                         ...
                         <asp:TemplateField HeaderStyle-Width="300PX" HeaderText="REASONS">
                             <ItemTemplate>
                         ...
                         <asp:CommandField ControlStyle-CssClass="btn btn-success" ControlStyle-Width="100px" HeaderText="EDIT" ItemStyle-Width="120px" ShowEditButton="true" />
                         <asp:CommandField ControlStyle-CssClass="btn btn-danger" HeaderText="REMOVE" ItemStyle-Width="120px" ShowDeleteButton="true" />
                     </Columns>
                     <FooterStyle BackColor="#99CCCC" ForeColor="#003399" />
                     <HeaderStyle BackColor="#003399" Font-Bold="True" ForeColor="#CCCCFF" />
                     <PagerStyle BackColor="#99CCCC" ForeColor="#003399" HorizontalAlign="Center" />
...
<br />
           ...
           <%-- SIX--%>
            ...
            <asp:GridView ID="GridView6" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" OnRowCancelingEdit="GridView6_RowCancelingEdit" OnRowDeleting="GridView6_RowDeleting" OnRowEditing="GridView6_RowEditing" OnRowUpdating="GridView6_RowUpdating">
                <Columns>
                       <asp:TemplateField HeaderText="SR_NO">
                        <ItemTemplate>
                            <asp:Label runat="server" Text='<%#Eval("srno")%>'></asp:Label>
           ...
           <%-- SEVEN--%>
            ...
            <asp:GridView ID="GridView7" Width="900" DataKeyNames="id" AutoGenerateColumns="False" runat="server" CellPadding="4" BackColor="White" BorderColor="#3366CC" BorderStyle="None" BorderWidth="1px" OnRowCancelingEdit="GridView7_RowCancelingEdit" OnRowDeleting="GridView7_RowDeleting" OnRowEditing="GridView7_RowEditing" OnRowUpdating="GridView7_RowUpdating">
                <Columns>
